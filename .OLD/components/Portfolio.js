            ...
            <Grid style={{marginTop: "5px"}} className="port-show">
              <Grid.Row>
                ...
                <Grid.Column width={4}>
                  ...
                  <Header style={{marginLeft: "10%"}} color="black" size="medium">Money Remaining: ${this.props.budgetForPortfolio ? this.removeExtraDecimals(this.numberWithCommas(this.props.budgetForPortfolio)) : 0.00}</Header>
                  {
